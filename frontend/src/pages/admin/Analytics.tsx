  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        {/* Conversations chart */}
        <div className="bg-background rounded-xl border border-border p-6 shadow-soft-sm">
          <h3 className="text-[15px] font-semibold text-foreground mb-1">Conversations</h3>
        ...
        <div className="bg-background rounded-xl border border-border p-6 shadow-soft-sm">
          <h3 className="text-[15px] font-semibold text-foreground mb-1">Resolution Rate</h3>
          <p className="text-[13px] text-muted-foreground mb-6">Last 7 days</p>
          <ResponsiveContainer width="100%" height={200}>
      ...
      <div className="bg-background rounded-xl border border-border shadow-soft-sm">
        <div className="px-6 py-4 border-b border-border">
          <h3 className="text-[15px] font-semibold text-foreground">Top Question Categories</h3>
        </div>
